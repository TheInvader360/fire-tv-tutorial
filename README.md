A sample application demonstrating how to build a LibGDX Android game that runs on touchscreen devices and FireTV (build a single apk that runs on all platforms).
